...
public class HomeFragment extends Fragment implements View.OnClickListener, AbsListView.OnScrollListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.home_activity, null);
        }
    ...
    public void findViewAll() {
        home_scro = (ScrollView) getActivity().findViewById(R.id.home_scro);
        home_btn_line = (LinearLayout)getActivity().findViewById(R.id.home_btn_line);
        home_check1 = (Button) getActivity().findViewById(R.id.home_check1);
        home_check1.setOnClickListener(this);
        home_btn_line.setOnClickListener(this);
        home_check2 = (Button) getActivity().findViewById(R.id.home_check2);
        home_check2.setOnClickListener(this);
        home_check1.setTextColor(getResources().getColor(R.color._ffffff));
        home_question1 = (TextView) getActivity().findViewById(R.id.home_question1);
        home_question2 = (TextView) getActivity().findViewById(R.id.home_question2);
        home_question3 = (TextView) getActivity().findViewById(R.id.home_question3);
        home_question4 = (TextView) getActivity().findViewById(R.id.home_question4);
        home_question5 = (TextView) getActivity().findViewById(R.id.home_question5);
        home_question6 = (TextView) getActivity().findViewById(R.id.home_question6);
        home_question7 = (TextView) getActivity().findViewById(R.id.home_question7);
        home_question8 = (TextView) getActivity().findViewById(R.id.home_question8);
        home_line_question1 = (LinearLayout) getActivity().findViewById(R.id.home_line_question1);
        home_line_question2 = (LinearLayout) getActivity().findViewById(R.id.home_line_question2);
        home_line_question3 = (LinearLayout) getActivity().findViewById(R.id.home_line_question3);
        home_line_question4 = (LinearLayout) getActivity().findViewById(R.id.home_line_question4);
        home_line_question5 = (LinearLayout) getActivity().findViewById(R.id.home_line_question5);
        home_line_question6 = (LinearLayout) getActivity().findViewById(R.id.home_line_question6);
        home_line_question7 = (LinearLayout) getActivity().findViewById(R.id.home_line_question7);
        home_line_question8 = (LinearLayout) getActivity().findViewById(R.id.home_line_question8);
        home_xuanzi_edt= (LimitEditText) getActivity().findViewById(R.id.home_xuanzi_edt);
        home_order_edt1 = (EditText) getActivity().findViewById(R.id.home_order_edt1);
        home_order_edt2 = (EditText) getActivity().findViewById(R.id.home_order_edt2);
        home_born_data_line = (LinearLayout) getActivity().findViewById(R.id.home_born_data_line);
        home_born_hour_line = (LinearLayout) getActivity().findViewById(R.id.home_born_hour_line);
        home_call_phone = (ImageView) getActivity().findViewById(R.id.home_call_phone);
        home_call_phone.setOnClickListener(this);
        home_qq_phone = (ImageView) getActivity().findViewById(R.id.home_qq_phone);
        ...
        home_banner2_line = (LinearLayout) getActivity().findViewById(R.id.home_banner2_line);
        home_banner2_Img = (ImageView) getActivity().findViewById(R.id.home_banner2_Img);
        home_check_nan = (CheckBox) getActivity().findViewById(R.id.home_check_nan);
        home_check_nv = (CheckBox) getActivity().findViewById(R.id.home_check_nv);
        home_check_nan.setOnClickListener(this);
        home_check_nv.setOnClickListener(this);
        home_dan_ck = (CheckBox) getActivity().findViewById(R.id.home_dan_ck);
        home_shuang_ck = (CheckBox) getActivity().findViewById(R.id.home_shuang_ck);
        home_dingzi_ck = (CheckBox) getActivity().findViewById(R.id.home_dingzi_ck);
        ...
        home_born_data_tv = (TextView) getActivity().findViewById(R.id.home_born_data_tv);
        home_born_hour_tv = (TextView) getActivity().findViewById(R.id.home_born_hour_tv);
        home_btn_quming = (Button) getActivity().findViewById(R.id.home_btn_quming);
        home_btn_quming.setOnClickListener(this);
        home_bottom_btn = (Button) getActivity().findViewById(R.id.home_bottom_btn);
        home_bottom_btn.setOnClickListener(this);
        view1 = (View) getActivity().findViewById(R.id.view1);
        view2 = (View) getActivity().findViewById(R.id.view2);
        timer();
        editText = (LimitEditText) getActivity().findViewById(R.id.editText);
        home_order_tv1 = (TextView) getActivity().findViewById(R.id.home_order_tv1);
        home_order_tv2 = (TextView) getActivity().findViewById(R.id.home_order_tv2);
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("test_user", Activity.MODE_PRIVATE);
        int be = sharedPreferences.getInt("num_pep", 482641);
        device = getUniquePsuedoID();
        SPUtil.put(getActivity().getApplication(), "device", device);
        ...
        SPUtil.put(getActivity(), "num_pep", adc);
...
//        device = TelephonyMgr.getDeviceId();
        home_order_bt1 = (Button) getActivity().findViewById(R.id.home_order_bt1);
        home_order_bt1.setOnClickListener(this);
        home_order_bt2 = (Button) getActivity().findViewById(R.id.home_order_bt2);
...
//                startActivity(intent);
            ...
            case R.id.home_order_bt1:
                ...
                if (!"".equals(home_order_edt1.getText().toString())) {
                    ...
                    Toast.makeText(getActivity(), "请输入订单号", Toast.LENGTH_SHORT).show();
                }
//                Toast.makeText(MainActivity.this, "功能开发中，敬请期待", Toast.LENGTH_SHORT).show();
            ...
            case R.id.home_qq_phone:
                if (!isQQClientAvailable(getActivity())) {
                    Toast.makeText(getActivity(), "未安装QQ，请拨打电话", Toast.LENGTH_SHORT).show();
                } else {
...
//                LogUtils.e("pn = "+pn);
        ...
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onAfter(int id) {
                if (paych.equals("null")) {
                    Toast.makeText(getActivity(), "不存在该订单，请重新下单", Toast.LENGTH_SHORT).show();
                }
    ...
    private void okhttpPost() {
        ...
        if (surname.equals("")) {
            Toast.makeText(getActivity(), "请填写姓氏", Toast.LENGTH_SHORT).show();
        } else {
            if (brithday.equals("")) {
                Toast.makeText(getActivity(), "请填写出生日期", Toast.LENGTH_SHORT).show();
            } else {
                if (brithHour.equals("")) {
                    Toast.makeText(getActivity(), "请填写出生时辰", Toast.LENGTH_SHORT).show();
                }
            }
        }
...
//                                Toast.makeText(MainActivity.this, "网络异常，请检查网络", Toast.LENGTH_SHORT).show();
                                        ...
                                        if (isPay.equals("1")) {
                                            ...
                                            if (getHistoryOrderBean != null) {
                                                ...
                                                if (Constant.isMeizu) {
                                                    ...
                                                    intent1.setClass(getActivity(), OrderActivity.class);
                                                    startActivity(intent1);
                                                    LBStat.click(1067);
                                                }

                                            } else {
                                                Toast.makeText(getActivity(), "不存在该姓氏，请重新输入", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                    ...
                    Toast.makeText(getActivity(), "请输入要定的字", Toast.LENGTH_SHORT).show();
                }
            }else{
                home_xuanzi_edt.setText("");
                if (!surname.equals("") && !brithday.equals("") && !brithHour.equals("")) {
